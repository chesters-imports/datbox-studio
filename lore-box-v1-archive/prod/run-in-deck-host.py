...
# Archive v1 — live loreBOX v2 owns 42929
URL = os.environ.get("LOREBOX_URL", "http://127.0.0.1:42928/")
HEALTH = os.environ.get("LOREBOX_HEALTH", "http://127.0.0.1:42928/api/health")
PORT = os.environ.get("LOREBOX_PORT", "42928")
